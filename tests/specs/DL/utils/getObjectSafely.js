describe('DL.getObjectSafely()', function () {

    it('is define', function () {
        expect(DL.getObjectSafely).toBeDefined();
    });

    it('is function', function () {
        expect(DL.getObjectSafely).toEqual(jasmine.any(Function));
    });
    ...
    describe('set for define object and properties', function () {
        ...
        foundFourth = DL.getObjectSafely(object, 'first', 'second', 'third', 'fourth');
    ...
    it('correct when some property is not object', function () {
        ...
        fourth = DL.getObjectSafely(object, 'first', 'second', 'third', 'fourth');
    ...
    describe('set for undefined properties', function () {
        ...
        DL.getObjectSafely(object, 'first', 'second', 'third', 'fourth').value = settingValue;
