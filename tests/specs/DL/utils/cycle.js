...
describe('DL.cycle', function () {
    ...
    it('DL.cycleStopKey is define', function () {
        expect(DL.cycleStopKey).toBeDefined();
    });
    it('DL.cycleStopObject is define', function () {
        expect(DL.cycleStopObject).toBeDefined();
    });
            ...
            describe('break array processing with value', function () {
                ...
                returnedResult = cycle(
                    ...
                    function (item, index, cycleable, data) {
                        outsideStorageWriter(storages, item, index, cycleable, data, this);
                        if (index === 4) {
                            DL.cycleStopObject.result = result;
                ...
                it('DL.cycleStopObject is clean', function () {
                    expect(DL.cycleStopObject.result).toBe(null);
                });
    ...
    describe('DL.reversiveCycle()', function () {
        it('is define', function () {
            expect(DL.reversiveCycle).toBeDefined();
        });

        it('is function', function () {
            expect(DL.reversiveCycle).toEqual(jasmine.any(Function));
        });

        var reversiveCycle = DL.reversiveCycle;
    ...
    //TODO: [dmitry.makhnev] write tests
});